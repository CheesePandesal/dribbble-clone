...
const Footer = () => {
  return (
    <footer className="w-full px-8 py-3 bg-[#fafafb]">
      <div className="flex items-center flex-col">
        <div className="flex flex-col gap-8 xl:flex-row xl:gap-16 lg:pt-8 px-8 lg:pb-14">
          <div className="pt-10 flex gap-4 flex-col w-[250px]">
            <a href="/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 96 24"
                role="img"
                aria-labelledby="ahdu0e7wanoazd80nqd3hn06kfxx2wfg"
                className="w-[104px] fill-[#ea4c89]"
              >
                <title id="ahdu0e7wanoazd80nqd3hn06kfxx2wfg">
              ...
              <span className="hidden">Back to home page</span>
            </a>
            <p className="text-sm">
            ...
            <div className="flex gap-3">
              <span className="text-gray-700 hover:text-gray-950 cursor-pointer">
                <PiBasketballLight size={18} />
              </span>
              <span className="text-gray-700 hover:text-gray-950 cursor-pointer">
                <BsTwitter size={18} />
              </span>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-5 items-start">
      ...
      <div className="border-t-2 w-full flex justify-center text-center p-8 text-[#2f4f4f] xl:text-start xl:justify-between 2xl:px-36">
        <div className="xl:flex xl:w-full xl:justify-between">
          <div>
            <span>© 2023 Dribbble. All rights reserved.</span>
          </div>
          <div className="xl:flex xl:items-center xl:flex-row-reverse xl:gap-2">
            <div className="flex justify-center">
              <span>
                <GiBasketballBall className="text-[#ea4c89]" size={25}/>
              </span>
            </div>
            <span>
              <strong className="text-black mr-1">22,087,759</strong>
              shots dribbled
            </span>
          </div>
        </div>
